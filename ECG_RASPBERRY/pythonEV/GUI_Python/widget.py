...
class InfoWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self.connection.setStyleSheet("background-color: black; color: red; max-height: 100px; border-width: 2px; border-style: solid; border-color: gray; font-size: 15px; text-align: center")
